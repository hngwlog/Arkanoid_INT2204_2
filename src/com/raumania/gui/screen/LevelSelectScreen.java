...
public class LevelSelectScreen extends Screen {
    ...
    public LevelSelectScreen(SceneManager sceneManager) {
        ...
        level.layoutBoundsProperty()
                .addListener(
                        (obs, oldVal, newVal) -> {
                            ...
                            double leftX =
                                    level.getLayoutX() - gap - left.getLayoutBounds().getWidth();
                            double rightX = level.getLayoutX() + gap + newVal.getWidth();
        ...
        level.setOnAction(
                e -> {
                    MapLoader.LevelData levelData =
                            MapLoader.loadLevel("level_" + (currentLevel + 1));
